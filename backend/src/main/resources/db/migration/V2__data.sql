...
VALUES (DEFAULT, 'Corsa', 'Opel', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Zafira', 'Opel', 'S7-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Fiesta', 'Ford', 'S4-CT-AT-B2', DEFAULT),
       (DEFAULT, 'Aygo', 'Toyota', 'S4-CT-AT-B2', DEFAULT),
       (DEFAULT, 'Captur', 'Renault', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Twingo', 'Renault', 'S4-CT-AT-B2', DEFAULT),
       (DEFAULT, 'Mokka', 'Opel', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, '5008', 'Peugeot', 'S7-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Stonic', 'Kia', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'V40', 'Volvo', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, '318', 'BMW', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'C-Class', 'Mercedes-Benz', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'C3', 'Citroen', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'CR-V', 'Honda', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'C-Max', 'Ford', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Vivaro', 'Opel', 'S9-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Pulsar', 'Nissan', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Cooper Cabriao', 'Mini', 'S4-CT-AT-B2', DEFAULT),
       (DEFAULT, 'Traffic', 'Renault', 'S9-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Qashqai', 'Nissan', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Renegade', 'Jeep', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Megane', 'Renault', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Juke', 'Nissan', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Yaris', 'Toyota', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Espace', 'Renault', 'S5-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Astra', 'Opel', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Golf', 'Volkswagen', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Touran', 'Volkswagen', 'S5-CT-AF-B4', DEFAULT),
       (DEFAULT, 'T-ROC', 'Volkswagen', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Camry', 'Toyata', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Mondeo', 'Ford', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'A4', 'Audi', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Focus', 'Ford', 'S5-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Caddy', 'Volkswagen', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Baleno', 'Suzuki', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Avensis', 'Toyota', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Spark', 'Chevrolet', 'S4-CT-AT-B2', DEFAULT),
       (DEFAULT, 'Passat', 'Volkswagen', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Evalia', 'Nissan', 'S7-CT-AF-B4', DEFAULT),
       (DEFAULT, 'Corolla', 'Toyota', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'X1', 'BMW', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Auris', 'Toyota', 'S5-CT-AF-B3', DEFAULT),
       (DEFAULT, 'Punto', 'Fiat', 'S5-CT-AF-B2', DEFAULT),
       (DEFAULT, 'Venga', 'Kia', 'S5-CT-AF-B2', DEFAULT),
